function [V, xyt, mly_ts, atmo_paths]  = load_timeseries(V, F, xyt, path_input, options)
...
%     df = standardizeMissing(df, -9999); > 2013a
 ...
 if options.dynamic_azimuth
     [sazi, relazi]     = calcazimuthangle(DOY_,time_ - xyt.timezn,xyt.LON,xyt.LAT,V(69).Val,V(51).Val);
     V(53).Val  = relazi;
