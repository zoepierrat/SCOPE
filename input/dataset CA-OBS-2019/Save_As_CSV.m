...
T = table(y,doy,OBS_IncomingShortwaveRad_AbvCnpy.Value,OBS_IncomingLongwaveRad_AbvCnpy.Value,OBS_BarometricPressure.Value,OBS_AirTemp_AbvCnpy25m.Value,OBS_WindSpeed_AbvCnpy26m.Value,OBS_VapourPressure_AbvCnpy25m.Value);
